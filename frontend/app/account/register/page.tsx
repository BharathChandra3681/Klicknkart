        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '36px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#444650', margin: 0, lineHeight: 1.5 }}>
              Sign up securely. Choose your preferred method below.
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <span style={{ fontSize: '10px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#9ea0ab', whiteSpace: 'nowrap' }}>or</span>
              <div style={{ flex: 1, height: '1px', background: 'rgba(0,17,58,0.08)' }} />
            </div>
            ...
            <button
              onClick={handleShopifySignup}
              style={{ width: '100%', padding: '13px', borderRadius: '8px', border: '1px solid rgba(0,17,58,0.15)', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer', fontSize: '14px', fontWeight: 600, color: '#00113a', fontFamily: 'inherit' }}
            >
