...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full z-50 border-b border-white/20 shadow-[0_8px_32px_0_rgba(0,35,102,0.05)]"
        style={{ background: 'rgba(255,255,255,0.4)', backdropFilter: 'blur(30px)', WebkitBackdropFilter: 'blur(30px)' }}>
        <div className="flex justify-between items-center h-20 px-12 max-w-full">
          ...
          <div className="flex items-center gap-2 text-primary">
            <Link
              href="/search"
              className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/50 transition-all duration-300"
            >
            ...
            <button
              ...
              className="relative w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/50 transition-all duration-300"
